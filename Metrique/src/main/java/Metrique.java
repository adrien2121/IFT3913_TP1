...
public final class Metrique {
	...
	/**
     * Store le nom du path, et les informations pour les rapports de classes et m�thodes.
     * Pass� au visiteur qui popule les informations pour les rapports.
     */
    public static class VisitorState {
        ...
        public List<RapportMethodes> rMethodes = new ArrayList<>(); //Infos du rapport pour les m�thodes
    }
    
	/**
     * Visiter un fichier de code Java et ajoute les donn�es de m�triques.
