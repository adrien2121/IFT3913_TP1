...
public final class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //Cree les rapports pour classes et methodes.
        try (var printC = new PrintStream("classes.csv")) {
        	printC.print(metrique.getClassReport());
        }
        try (var printM = new PrintStream("methodes.csv")) {
        	printM.print(metrique.getMethodReports());
        }
    }
}
