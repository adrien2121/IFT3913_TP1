 ...
 * 
 */
public class Visiteur extends VoidVisitorAdapter<Metrique.VisitorState> {

    @Override
    public void visit(MethodDeclaration method, Metrique.VisitorState infos) {
    ...
    @Override
    public void visit(EnumDeclaration dec, Metrique.VisitorState infos) {
        super.visit(dec, infos);
        visitClassLike(dec, infos, 0);
    }

    @Override
    public void visit(ClassOrInterfaceDeclaration dec, Metrique.VisitorState infos) {
        super.visit(dec, infos);
	...
	private void visitClassLike(Node declaration, Metrique.VisitorState infos, int wmc) {
