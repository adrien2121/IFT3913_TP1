...
import Metrique.Metrique.VisitorState;
 ...
 * 
 */
public class VisiteurClasse extends VoidVisitorAdapter<VisitorState> {
    private AtomicInteger wmc = new AtomicInteger(0);

    @Override
    public void visit(MethodDeclaration dec, VisitorState infos) {
